...
public class RenderGearbox extends TileEntitySpecialRenderer {
	...
	public void renderTileEntityAt(TileEntity tiletemp, double x, double y, double z, float f) {
		...
		IIcon[][] textures = new IIcon[][] {{Blocks.planks.getIcon(0, 5),Blocks.planks.getIcon(0, 2),Blocks.planks.getIcon(0, 0)},{DerpyBlocks.oreBlocks.getIcon(0, 2),Blocks.iron_block.getIcon(0, 0),Blocks.gold_block.getIcon(0, 0)}};
